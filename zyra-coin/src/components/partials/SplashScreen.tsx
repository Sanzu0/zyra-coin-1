...
export default function SplashScreen() {
  ...
  return (
    ...
    >
      <img src="/images/logo.png" alt="logo" className="h-100 max-w-full" />
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col items-center w-full pb-4 bg-[url('/images/blur.png')] bg-cover bg-center">
